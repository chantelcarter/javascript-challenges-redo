...
//     return parseFloat((product.price * .07 + product.price).toFixed(2))
// }
...
// const stringLunch = lunch => {
//     return `the ingredients for a ${lunch.name} ${lunch.type} are ${lunch.ingredients[0]}, ${lunch.ingredients[1]}, and ${lunch.ingredients[2]}.`
// }
// console.log(stringLunch(lunch))
...
// const arrayOfAnimals = animals.filter((value) => {
...
// const namesOfAnimals = animals.map((value) => {
//     return value.name
// })
// console.log(namesOfAnimals)
// ----> [ 'Waffles', 'Fluffy', 'Spelunky', 'Hank' ]
// Create a function that takes in an array of animal objects and returns a new array of the names of the animals that are more than 10 years old.
// const ageOfAnimals = animals.filter((value) => value.age > 10)
// console.log(ageOfAnimals)
// did the shorthand version
// ----> [
//   { name: 'Fluffy', type: 'cat', age: 14 },
//   { name: 'Hank', type: 'cat', age: 11 }
// ]
// Create a function that takes in an array of animal objects and returns a new array with a sentence about each animal.
// const sentenceForAnimals = animals.map((value) => `${value.name} is a ${value.type} and is ${value.age} years old.`)
// console.log(sentenceForAnimals)
// ----> [
//   'Waffles is a dog and is 7 years old.',
//   'Fluffy is a cat and is 14 years old.',
//   'Spelunky is a dog and is 4 years old.',
//   'Hank is a cat and is 11 years old.'
// ]
...
//     return `${object.species} is a ${object.pokemon_type}`
// }
